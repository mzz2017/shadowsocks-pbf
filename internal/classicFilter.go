// Modified from https://github.com/riobard/go-bloom/blob/master/filter.go
// Apache-2.0 License
...
// NewClassicFilter creates a classic Bloom Filter that is optimal for n entries and false positive rate of p.
